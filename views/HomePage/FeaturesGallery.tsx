...
const TABS = [
  {
    title: 'ICT Systemes Development and Maintenance Services',
    description:
  ...
  {
    title: 'ICT Technical Support Services',
    description:
      '<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam quidem ipsam ratione dicta quis cupiditate consequuntur laborum ducimus iusto velit.</p>',
  ...
  {
    title: 'Network and Facilities Management',
    description:
      '<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam quidem ipsam ratione dicta quis cupiditate consequuntur laborum ducimus iusto velit.</p>',
...
export default function FeaturesGallery() {
  ...
  return (
    <FeaturesGalleryWrapper>
      <Content>
        <OverTitle>ICT Tools</OverTitle>
        <SectionTitle>Here's some of our ICT services</SectionTitle>
      </Content>
      <GalleryWrapper>
